...
var CONFIG_EN = {
    ...
    'error.account.emoney.notnull': 'eMoney account cannot be left blank',
    'error.account.wing.notnull': 'Wing account cannot be left blank',
    'error.account.emoney': 'eMoney account is invalid',
    'enter_account_emoney': 'Enter eMoney account',
    'enter_account_wing': 'Enter Wing account',
