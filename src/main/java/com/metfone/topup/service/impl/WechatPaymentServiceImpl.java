...
@Service
public class WechatPaymentServiceImpl implements IPaymentService<PaymentRequest, WechatPaymentResponse> {

    @Value("${url.service}")
    String URL_SERVICE;

    @Value("${service.payment.wechat}")
    String WECHAT_PAYMENT_URI;

    @Override
    public WechatPaymentResponse initPayment(PaymentRequest paymentRequest) {
