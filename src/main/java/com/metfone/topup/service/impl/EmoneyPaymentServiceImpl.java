...
@Service
public class EmoneyPaymentServiceImpl implements IPaymentService<PaymentRequestEmoney, EmoneyPaymentResponse> {

    @Value("${url.service}")
    String URL_SERVICE;

    @Value("${service.payment.emoney}")
    String EMONEY_PAYMENT_URI;

    @Override
    public EmoneyPaymentResponse initPayment(PaymentRequestEmoney paymentRequest) {
