...
@Service
public class CyberPaymentServiceImpl implements IPaymentService<PaymentRequestCyber, CyberCardPaymentResponse> {
    ...
    @Override
    public CyberCardPaymentResponse initPayment(PaymentRequestCyber paymentRequest) {
