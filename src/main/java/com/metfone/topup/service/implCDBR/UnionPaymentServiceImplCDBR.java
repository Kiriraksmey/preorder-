...
@Service
public class UnionPaymentServiceImplCDBR implements IPaymentService<PaymentRequestCyberCDBR, UnionPaymentResponse> {

    @Value("${url.service}")
    String URL_SERVICE;

    @Value("${service.payment.union.cdbr}")
    String UNION_PAYMENT_URI;

    @Override
    public UnionPaymentResponse initPayment(PaymentRequestCyberCDBR paymentRequest) {
